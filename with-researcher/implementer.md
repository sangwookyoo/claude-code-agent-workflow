...
- Guidance Main labels as wiki-sourced is a suggestion, not a requirement. If it
  conflicts with existing code in this repository, follow the existing code and
  say so in Notes. Do not go read the wiki yourself.
